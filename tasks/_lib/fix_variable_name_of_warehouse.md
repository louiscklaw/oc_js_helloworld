...
1. i want you to review the source code of `dashboard/warehouses` and `components/warehouses`. you may still find some vairable(s)/function(s) named with `customer` or `customers`. please help to rename it.
1. i want you to review the source code of `src/app/api/db/warehouse` endpoint. you may still find some vairable(s)/function(s) named with `customer` or `customers`. please help to rename it.
1. i want you to review the source code of `src/db/controllers/warehouse` and `src/db/models/warehouse`. you may still find some vairable(s)/function(s) named with `customer` or `customers`. please help to rename it.
1. i want you to review the source code of `src/db/types/warehouse.d.ts`. you may still find some vairable(s)/function(s) named with `customer` or `customers`. please help to rename it.
