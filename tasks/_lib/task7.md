...
1. i want you to review the source code of `dashboard/warehouse` and `components/warehouse`. you may still find some vairable(s)/function(s) named with `customer` or `customers`. please help to rename it.
