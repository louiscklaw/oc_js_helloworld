...
1. create the raw-materials dashboard page at `src/app/dashboard/raw-materials/page.tsx`:
   1. Follow the same pattern as warehouse and employee pages
   1. Include search params for filtering (name, category, status, supplier, etc.)
   1. Include sorting functionality
   1. Include pagination
   1. Include "Add New" button
   1. Connect to the raw-materials API endpoints
1. create the necessary components for raw-materials:
   1. `src/components/dashboard/raw-materials/raw-materials-filters.tsx`
   1. `src/components/dashboard/raw-materials/raw-materials-table.tsx`
   1. `src/components/dashboard/raw-materials/raw-materials-pagination.tsx`
   1. `src/components/dashboard/raw-materials/raw-materials-selection-context.tsx`
   1. `src/components/dashboard/raw-materials/i-raw-material.tsx`
1. create the API integration functions:
   1. `src/app/dashboard/raw-materials/api/list-raw-materials-row.ts`
1. create the create page:
   1. `src/app/dashboard/raw-materials/create/page.tsx`
1. create the edit page:
   1. `src/app/dashboard/raw-materials/edit/[rowId]/page.tsx`
1. create the detail page:
   1. `src/app/dashboard/raw-materials/[rowId]/page.tsx`
1. update the paths configuration to include raw-materials routes
