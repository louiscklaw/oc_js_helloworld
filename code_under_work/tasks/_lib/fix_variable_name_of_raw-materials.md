...
1. i want you to review the source code of `dashboard/raw-materials` and `components/raw-materials`. you may still find some vairable(s)/function(s) named with `customer` or `customers`. please help to rename it.
1. i want you to review the source code of `src/app/api/db/raw-material` endpoint. you may still find some vairable(s)/function(s) named with `customer` or `customers`. please help to rename it.
1. i want you to review the source code of `src/db/controllers/raw-material` and `src/db/models/raw-material`. you may still find some vairable(s)/function(s) named with `customer` or `customers`. please help to rename it.
1. i want you to review the source code of `src/db/types/raw-material.d.ts`. you may still find some vairable(s)/function(s) named with `customer` or `customers`. please help to rename it.
