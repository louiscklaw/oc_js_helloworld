...
1. create the finished-products dashboard page at `src/app/dashboard/finished-products/page.tsx`:
   1. Follow the same pattern as warehouse and employee pages
   1. Include search params for filtering (name, category, status, etc.)
   1. Include sorting functionality
   1. Include pagination
   1. Include "Add New" button
   1. Connect to the finished-products API endpoints
1. create the necessary components for finished-products:
   1. `src/components/dashboard/finished-products/finished-products-filters.tsx`
   1. `src/components/dashboard/finished-products/finished-products-table.tsx`
   1. `src/components/dashboard/finished-products/finished-products-pagination.tsx`
   1. `src/components/dashboard/finished-products/finished-products-selection-context.tsx`
   1. `src/components/dashboard/finished-products/i-finished-product.tsx`
1. create the API integration functions:
   1. `src/app/dashboard/finished-products/api/list-finished-products-row.ts`
1. create the create page:
   1. `src/app/dashboard/finished-products/create/page.tsx`
1. create the edit page:
   1. `src/app/dashboard/finished-products/edit/[rowId]/page.tsx`
1. create the detail page:
   1. `src/app/dashboard/finished-products/[rowId]/page.tsx`
1. update the paths configuration to include finished-products routes
