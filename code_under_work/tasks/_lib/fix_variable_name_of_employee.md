...
1. i want you to review the source code of `dashboard/employees` and `components/employees`. you may still find some vairable(s)/function(s) named with `customer` or `customers`. please help to rename it.
1. i want you to review the source code of `src/app/api/db/employee` endpoint. you may still find some vairable(s)/function(s) named with `customer` or `customers`. please help to rename it.
1. i want you to review the source code of `src/db/controllers/employee` and `src/db/models/employee`. you may still find some vairable(s)/function(s) named with `customer` or `customers`. please help to rename it.
1. i want you to review the source code of `src/db/types/employee.d.ts`. you may still find some vairable(s)/function(s) named with `customer` or `customers`. please help to rename it.
